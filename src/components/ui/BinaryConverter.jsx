  ...
  const handleConvert = () => {
    ...
    switch (conversionType) {
      ...
      case "binaryToDecimal":
        ...
        break;
      case "decimalToHex":
        conversionResult = (parseInt(inputValue, 10) || 0)
          .toString(16)
          .toUpperCase();
        break;
      case "hexToDecimal":
      ...
      case "degreesToRadians":
        conversionResult = (parseFloat(inputValue) * (Math.PI / 180)).toFixed(
          5
        );
        break;
      case "radiansToDegrees":
        conversionResult = (parseFloat(inputValue) * (180 / Math.PI)).toFixed(
          5
        );
        break;
      default:
      ...
      <div className="bg-purple-400 shadow-lg rounded-lg p-6 w-full max-w-md">
        ...
        <div className="mt-4">
          ...
          <div className="text-sm text-gray-700">
            <p>
              <strong className="text-gray-800 text-4xl text-center">
                Converted Value:
              </strong>{" "}
              <span className="text-gray-900 text-3xl">{result}</span>
            </p>
          </div>
        </div>
      </div>
